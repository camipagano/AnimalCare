...
Nel caso in cui non sarà presente in negozio qualche prodotto del catalogo, c'è la possibilità di ordinarlo direttamente sul posto, vi basterà rivolgervi ai nostri dipendenti.</p>

<h2 class="sottotitolo">Informazioni sugli ordini</h2>
<p> Gli ordini online (che siano dal sito o in negozio) arrivano tra i 2 e i 7 giorni lavorativi, a seconda della disponibilità dei prodotti selezionati in magazzino. <br>
Potrete sempre tenere traccia dei vostri ordini (nel caso in cui li abbiate ordinati dal sito) facendo il login e andando nella sezione "Gestisci ordini".<br>
...
<p>Nel caso abbiate bisogno di comunicare con un responsabile, troverete tutti i <a href="<%= request.getContextPath() %>/ContattiServlet">contatti qui</a></p>
</main>
